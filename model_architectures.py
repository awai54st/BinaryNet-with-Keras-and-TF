...
def get_model(dataset,resid_levels,batch_size):
	if dataset=='MNIST':
		...
		model.add(l1_batch_norm_vanilla_dense(batch_size=batch_size,ch_in=256,momentum=batch_norm_momentum))
		...
		model.add(l1_batch_norm_vanilla_dense(batch_size=batch_size,ch_in=10,momentum=batch_norm_momentum))
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=30,ch_in=64,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=28,ch_in=64,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=12,ch_in=128,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=10,ch_in=128,momentum=batch_norm_momentum))
		model.add(binary_activation())
		model.add(MaxPooling2D(pool_size=(2, 2),strides=(2,2)))
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=3,ch_in=256,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=1,ch_in=256,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_dense(batch_size=batch_size,ch_in=512,momentum=batch_norm_momentum))
		model.add(binary_activation())
		model.add(binary_dense(n_in=int(model.output.get_shape()[1]),n_out=512))
		#model.add(BatchNormalization(axis=-1, momentum=batch_norm_momentum, epsilon=batch_norm_eps))
		#model.add(l1_batch_norm_mod_dense(batch_size=batch_size,ch_in=512,momentum=batch_norm_momentum))
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=32,ch_in=128,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=16,ch_in=128,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=16,ch_in=256,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=8,ch_in=256,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=8,ch_in=512,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_conv(batch_size=batch_size,width_in=4,ch_in=512,momentum=batch_norm_momentum))
		model.add(binary_activation())
		...
		model.add(l1_batch_norm_vanilla_dense(batch_size=batch_size,ch_in=1024,momentum=batch_norm_momentum))
		model.add(binary_activation())
		model.add(binary_dense(n_in=int(model.output.get_shape()[1]),n_out=1024))
		#model.add(BatchNormalization(axis=-1, momentum=batch_norm_momentum, epsilon=batch_norm_eps))
		#model.add(l1_batch_norm_mod_dense(batch_size=batch_size,ch_in=1024,momentum=batch_norm_momentum))
